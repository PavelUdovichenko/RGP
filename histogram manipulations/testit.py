...
def main():
    img_1 = cv2.imread('pic1.png', cv2.IMREAD_GRAYSCALE)  # исходное изображение
    img_2 = cv2.imread('pic2.png', cv2.IMREAD_GRAYSCALE)  # целевое изображение
...
def matching_histogram(img__1, img__2):  # метод для приведения гистограммы исх. изображения к целевому
    ...
    plt.show()
    cv2.imshow('Matching histogram result', new_img)
